...
import HotelBillaInfo from "./HotelBillaInfo";
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={3}>
                    <Box className="leftshadow">
                      <Typography className="selectfilter">Select Filter</Typography>
                      ...
                      <Box>
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          ...
                          <Typography className="value"> 5 Star Properties</Typography>
                        ...
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          ...
                          <Typography className="value"> North Goa</Typography>
                          <Typography style={{ flexGrow: 1 }} className="value">(12)</Typography>
                        </Box>
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          <Typography className="content">
                          ...
                          <Typography className="value"> Beach Front</Typography>
                          <Typography style={{ flexGrow: 1 }} className="value">(12)</Typography>
                        </Box>
                      </Box>
                      <Divider sx={{ backgroundColor: 'gray', marginY: '8px' }} />
                      ...
                      <Box>
                        <Box style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                          <Typography className="starrating"> Booking Prefrence</Typography>
                          <Box>
                            <Typography className="clearfilter">Clear Filter</Typography>
                          </Box>
                        </Box>
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          ...
                          <Typography className="value">Entire Property</Typography>
                          <Typography style={{ flexGrow: 1 }} className="value">(12)</Typography>
                        </Box>
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          <Typography className="content">
                          ...
                          <Typography className="value">Caretaker</Typography>
                          <Typography style={{ flexGrow: 1 }} className="value">(12)</Typography>
                        </Box>
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          <Typography className="content">
                          ...
                          <Typography className="value">Instant Book</Typography>
                          <Typography style={{ flexGrow: 1 }} className="value">(12)</Typography>
                        </Box>
                        <Box style={{ display: "flex", alignItems: "center", marginTop: "8px" }}>
                          <Typography className="content">
                          ...
                          <Typography className="value">Homestays</Typography>
                          <Typography style={{ flexGrow: 1 }} className="value">(12)</Typography>
                        </Box>
                  ...
                  <Grid item xs={12} md={9}>
                    <Box>
                      <Typography className="title">Showing Properties in Goa</Typography>
                    </Box>
                    <HotelBillaInfo />
                    <HotelBillaInfo />
                    <HotelBillaInfo />
