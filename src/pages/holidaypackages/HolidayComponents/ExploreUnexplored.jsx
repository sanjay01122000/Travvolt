...
import canada from "../../../images/img/canada.jpg";
                ...
                <div className="container homeform_container">
                    <Box mt={3}>
                        <Paper elevation={3} py={10} sx={{ borderRadius: '15px', }}>
                            <Box pt={2}>
                                <Typography className="Inter_national">Explore the Unexplored</Typography>
                                ...
                                <Box pb={2}>
                                    <div className="card_wrapper" >
                                        <div className="international_image">
                                            <img src={canada} alt="cardimage" style={{ width: "100%", height: '100%', margin: "auto", borderRadius: '15px', padding: '10px', }} />
                                        </div>
                                        <Box my={1}>
