                            ...
                            <Box className='passenger_form_container'>
                                    ...
                                    <Grid container spacing={3} my={1}>
                                        ...
                                        <Grid item xs={12} sm={12} md={3}>
                                            <Box className="topest_field" >
                                                ...
                                                <input type='number' name="m_number" placeholder='Enter Your Mobile Number ' />
                                            </Box>
                                        </Grid>
                                    </Grid>
                                </Box>
                                ...
                                <Box>
                                    <Grid container spacing={3} my={1}>
                                        <Grid item xs={12} sm={12} md={3}>
                                            <Box className="topest_field" >
                                                <label className="label_field">GST Details<span style={{ color: 'red' }}>*</span></label>
                                                <input type='text' name="city" placeholder='Enter Your City' />
                                            </Box>
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={3}>
                                            <Box className="topest_field" >
                                                <label className="label_field">GST State<span style={{ color: 'red' }}>*</span></label>
                                                <select className="select_class">
                                                    <option>Select</option>
                                                    <option>1</option>
                                                    <option>2</option>
                                        ...
                                        <Grid item xs={12} sm={12} md={4}>
                                            <Box className="topest_field" >
                                                ...
                                                <input type='text' name="city" placeholder='Eg. House no. Street name ...' />
                                            </Box>
                                        </Grid>
                                    </Grid>
                                </Box>
                                ...
                                <Box>
                                    <Grid container spacing={3} my={1}>
                                        <Grid item xs={12} sm={12} md={12}>
                                            <Box className="topest_field" >
                                                {/* <label className="label_field">Request<span style={{ color: 'red' }}>*</span></label> */}
                                                <textarea type='email' name="emai" style={{width:'100%' ,borderRadius:'10px',border:'3px solid #DFDFDF'}} className='txt_area' placeholder='Enter Special Request' />
                                            </Box>
                                        </Grid>
                                    </Grid>
                                </Box>
