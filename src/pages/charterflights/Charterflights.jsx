...
// home css 
import "./charterflights.css";
import CharterFlightForm from "./charterflightForm/CharterFlightForm";
...
const Home = () => {
    return (
        <div className="home_panner">
            ...
            <CharterFlightForm header="Book International and Domestic Flights" />
