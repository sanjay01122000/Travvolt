                        ...
                        <Grid container spacing={2} >
                            ...
                            <Grid xs={6} md={6} >
                                <Item sx={{ boxShadow: '0px 0px 8px black', borderRadius: '20px' }} px={5}>
                                    <Box py={2} >
                                    <DialogTitle color='black' fontWeight='bold' justifyContent='start'>Verify with OTP</DialogTitle>
                                    <Typography fontSize="12px" color="black">Enter 4 digit OTP sent to 9874563210</Typography>
                                    </Box>
                                    <Box>
                                        <div  width="40px" height="50px" borderRadius="40px" backgroundColor="primary">
                                        <input type="number" placeholder='*' sx={{borderRadius:"25px"}}></input>
                                        </div>
